package com.priyankdevurkar.insight_service.service;

import com.priyankdevurkar.insight_service.client.UsageClient;
import com.priyankdevurkar.insight_service.dto.DeviceDto;
import com.priyankdevurkar.insight_service.dto.InsightDto;
import com.priyankdevurkar.insight_service.dto.UsageDto;
...
public class InsightService {
    ...
    public InsightDto getOverview(Long userId) {
        ...
        String prompt = new StringBuilder()
                .append("Analyse the following energy usage data and provide a " +
                        "concise overview with actionable insight.")
    ...
    public InsightDto getSavingTips(Long userId) {
        ...
        String prompt = new StringBuilder()
                ...
                .append("How can I reduce my energy consumption? how does it comapre to average households?")
